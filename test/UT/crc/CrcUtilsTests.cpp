...
{
    EXPECT_EQ(eul::crc::detail::reflect<17>(0b10000000000000000U), 0b00000000000000001UL);
    EXPECT_EQ(eul::crc::detail::reflect<17>(0b00000000000000001U), 0b10000000000000000UL);
    EXPECT_EQ(eul::crc::detail::reflect<17>(0b11001011000111010U), 0b01011100011010011UL);
    EXPECT_EQ(eul::crc::detail::reflect<17>(0b11000000000000000U), 0b00000000000000011UL);
    EXPECT_EQ(eul::crc::detail::reflect<17>(0b11000000000000001U), 0b10000000000000011UL);
    EXPECT_EQ(eul::crc::detail::reflect<17>(0b10001011000101010U), 0b01010100011010001UL);
    EXPECT_EQ(eul::crc::detail::reflect<17>(0b00000011010111010U), 0b01011101011000000UL);
    EXPECT_EQ(eul::crc::detail::reflect<17>(0b00001011000111011U), 0b11011100011010000UL);
}

TEST(CrcUtilsShould, reflect32Bits)
{
    EXPECT_EQ(eul::crc::detail::reflect<32>(0b10000000000000000000000000000000U), 0b00000000000000000000000000000001UL);
    EXPECT_EQ(eul::crc::detail::reflect<32>(0b10000000000000000000000000000011U), 0b11000000000000000000000000000001UL);
    EXPECT_EQ(eul::crc::detail::reflect<32>(0b00000000000000000000000000000011U), 0b11000000000000000000000000000000UL);
}

TEST(CrcUtilsShould, reflect33Bits)
{
    EXPECT_EQ(eul::crc::detail::reflect<33>(0b100000000000000000000000000000000UL), 0b000000000000000000000000000000001UL);
    EXPECT_EQ(eul::crc::detail::reflect<33>(0b100000000000000000000000000000011UL), 0b110000000000000000000000000000001UL);
    EXPECT_EQ(eul::crc::detail::reflect<33>(0b000000000000000000000000000000011UL), 0b110000000000000000000000000000000UL);
}
